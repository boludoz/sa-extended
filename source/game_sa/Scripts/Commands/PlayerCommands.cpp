...
/// SET_PLAYER_COORDINATES(0055) - Originally unsupported
void SetPlayerCoordinates(CRunningScript* S, CPlayerPed& player, CVector posn) {
    S->SetCharCoordinates(player, posn, true, true);
}
...
void notsa::script::commands::player::RegisterHandlers() {
    ...
    REGISTER_UNSUPPORTED_COMMAND_HANDLER(COMMAND_SET_PLAYER_COORDINATES, SetPlayerCoordinates);
