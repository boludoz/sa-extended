...
// Same values as rw::StencilOp / rw::StencilFunc, so they pass straight through
enum RwStencilOperation
{
	rwSTENCILOPERATIONNASTENCILOPERATION = 0,
	rwSTENCILOPERATIONKEEP = rw::STENCILKEEP,
	rwSTENCILOPERATIONZERO = rw::STENCILZERO,
	rwSTENCILOPERATIONREPLACE = rw::STENCILREPLACE,
	rwSTENCILOPERATIONINCRSAT = rw::STENCILINCSAT,
	rwSTENCILOPERATIONDECRSAT = rw::STENCILDECSAT,
	rwSTENCILOPERATIONINVERT = rw::STENCILINVERT,
	rwSTENCILOPERATIONINCR = rw::STENCILINC,
	rwSTENCILOPERATIONDECR = rw::STENCILDEC
};

enum RwStencilFunction
{
	rwSTENCILFUNCTIONNASTENCILFUNCTION = 0,
	rwSTENCILFUNCTIONNEVER = rw::STENCILNEVER,
	rwSTENCILFUNCTIONLESS = rw::STENCILLESS,
	rwSTENCILFUNCTIONEQUAL = rw::STENCILEQUAL,
	rwSTENCILFUNCTIONLESSEQUAL = rw::STENCILLESSEQUAL,
	rwSTENCILFUNCTIONGREATER = rw::STENCILGREATER,
	rwSTENCILFUNCTIONNOTEQUAL = rw::STENCILNOTEQUAL,
	rwSTENCILFUNCTIONGREATEREQUAL = rw::STENCILGREATEREQUAL,
