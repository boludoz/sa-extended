...
// SA code uses the D3D9 RW field names (designated initialisers included), so the
// immediate-mode vertices keep those names; the layout is librw's D3D vertex layout.
struct RwIm2DVertex
{
	RwReal   x, y, z;
	RwReal   rhw;
...
static_assert(sizeof(RwIm2DVertex) == sizeof(rw::RWDEVICE::Im2DVertex));
static_assert(offsetof(RwIm2DVertex, emissiveColor) == offsetof(rw::RWDEVICE::Im2DVertex, color));
static_assert(sizeof(RwIm3DVertex) == sizeof(rw::RWDEVICE::Im3DVertex));
static_assert(offsetof(RwIm3DVertex, color) == offsetof(rw::RWDEVICE::Im3DVertex, color));

inline rw::RWDEVICE::Im2DVertex* RwToLibrw(RwIm2DVertex* v) { return reinterpret_cast<rw::RWDEVICE::Im2DVertex*>(v); }
inline rw::RWDEVICE::Im3DVertex* RwToLibrw(RwIm3DVertex* v) { return reinterpret_cast<rw::RWDEVICE::Im3DVertex*>(v); }
