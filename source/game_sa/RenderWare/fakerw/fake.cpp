...
void RwIm2DVertexSetCameraZ(RwIm2DVertex *vert, RwReal camz) { RwToLibrw(vert)->setCameraZ(camz); }
void RwIm2DVertexSetRecipCameraZ(RwIm2DVertex *vert, RwReal recipz) { RwToLibrw(vert)->setRecipCameraZ(recipz); }
void RwIm2DVertexSetScreenX(RwIm2DVertex *vert, RwReal scrnx) { RwToLibrw(vert)->setScreenX(scrnx); }
void RwIm2DVertexSetScreenY(RwIm2DVertex *vert, RwReal scrny) { RwToLibrw(vert)->setScreenY(scrny); }
void RwIm2DVertexSetScreenZ(RwIm2DVertex *vert, RwReal scrnz) { RwToLibrw(vert)->setScreenZ(scrnz); }
void RwIm2DVertexSetU(RwIm2DVertex *vert, RwReal texU, RwReal recipz) { RwToLibrw(vert)->setU(texU, recipz); }
void RwIm2DVertexSetV(RwIm2DVertex *vert, RwReal texV, RwReal recipz) { RwToLibrw(vert)->setV(texV, recipz); }
void RwIm2DVertexSetIntRGBA(RwIm2DVertex *vert, RwUInt8 red, RwUInt8 green, RwUInt8 blue, RwUInt8 alpha) { RwToLibrw(vert)->setColor(red, green, blue, alpha); }
...
RwBool RwIm2DRenderLine(RwIm2DVertex *vertices, RwInt32 numVertices, RwInt32 vert1, RwInt32 vert2)
	{ im2d::RenderLine(RwToLibrw(vertices), numVertices, vert1, vert2); return true; }
RwBool RwIm2DRenderTriangle(RwIm2DVertex *vertices, RwInt32 numVertices, RwInt32 vert1, RwInt32 vert2, RwInt32 vert3 )
	{ im2d::RenderTriangle(RwToLibrw(vertices), numVertices, vert1, vert2, vert3); return true; }
RwBool RwIm2DRenderPrimitive(RwPrimitiveType primType, RwIm2DVertex *vertices, RwInt32 numVertices)
	{ im2d::RenderPrimitive((PrimitiveType)primType, RwToLibrw(vertices), numVertices); return true; }
RwBool RwIm2DRenderIndexedPrimitive(RwPrimitiveType primType, RwIm2DVertex *vertices, RwInt32 numVertices, RwImVertexIndex *indices, RwInt32 numIndices)
	{ im2d::RenderIndexedPrimitive((PrimitiveType)primType, RwToLibrw(vertices), numVertices, indices, numIndices); return true; }


void RwIm3DVertexSetPos(RwIm3DVertex *vert, RwReal x, RwReal y, RwReal z) { RwToLibrw(vert)->setX(x); RwToLibrw(vert)->setY(y); RwToLibrw(vert)->setZ(z); }
void RwIm3DVertexSetU(RwIm3DVertex *vert, RwReal u) { RwToLibrw(vert)->setU(u); }
void RwIm3DVertexSetV(RwIm3DVertex *vert, RwReal v) { RwToLibrw(vert)->setV(v); }
void RwIm3DVertexSetRGBA(RwIm3DVertex *vert, RwUInt8 r, RwUInt8 g, RwUInt8 b, RwUInt8 a) { RwToLibrw(vert)->setColor(r, g, b, a); }

void  *RwIm3DTransform(RwIm3DVertex *pVerts, RwUInt32 numVerts, RwMatrix *ltm, RwUInt32 flags) { im3d::Transform(RwToLibrw(pVerts), numVerts, ltm, flags); return pVerts; }
...
RwBool RwRenderStateSet(RwRenderState state, void *value)
{
	...
	// librw only knows always / >= / <, so fold the rest onto those
	case rwRENDERSTATEALPHATESTFUNCTION:
		switch(uival){
		case rwALPHATESTFUNCTIONLESS:
		case rwALPHATESTFUNCTIONLESSEQUAL: SetRenderState(ALPHATESTFUNC, ALPHALESS); break;
		case rwALPHATESTFUNCTIONGREATER:
		case rwALPHATESTFUNCTIONGREATEREQUAL: SetRenderState(ALPHATESTFUNC, ALPHAGREATEREQUAL); break;
		default: SetRenderState(ALPHATESTFUNC, ALPHAALWAYS); break;
		}
		return true;
...
RwRGBA *RpMaterialGetColor(const RpMaterial *material) { return const_cast<RwRGBA*>(&material->color); }
RpMaterial *RpMaterialSetSurfaceProperties(RpMaterial *material, const RwSurfaceProperties *surfaceProperties);
RwSurfaceProperties *RpMaterialGetSurfaceProperties(const RpMaterial *material) { return const_cast<RwSurfaceProperties*>(&material->surfaceProps); }
...
RwMatrixWeights *RpSkinGetVertexBoneWeights( RpSkin *skin ) { return (RwMatrixWeights*)skin->weights; }
